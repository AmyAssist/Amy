...
public class RemoteSR {
    ...
    /**
     * launch the chrome browser, open the remote-SR url immediately and prevent
     * microphone permission dialog by using a prepared user profile
     */
    private void launchChrome() {
        try {
            URL fileURL = getClass().getClassLoader().getResource("chrome_profile");
            if (fileURL == null) {
                throw new IOException("Couldn't get chrome_profile resource");
            }
