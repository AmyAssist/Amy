...
class GrammarTest {
	...
	String mainGrammar;
	String notMainGrammar;
	
	HashMap<String, Grammar> gramList;
	
	
	@BeforeEach
	void setup() {
		file1 = new File("resources/one");
		file2 = new File("resources/two");
		
		mainGrammar = "mainGrammar";
		notMainGrammar = "notMainGrammar";
		
		gramList = new HashMap<>();
	}
