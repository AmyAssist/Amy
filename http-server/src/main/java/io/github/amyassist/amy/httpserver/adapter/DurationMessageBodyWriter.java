...
/**
 * A Duration message body writer to write OutputStreams according to ISO-8601
 * 
...
public class DurationMessageBodyWriter implements MessageBodyWriter<Duration> {
	 ...
	 */
	@Override
	public void writeTo(Duration d, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
