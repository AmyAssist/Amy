...
public class ConfigurationRegistry extends AbstractTaggableRegistry<ConfiguartionEntry> {
	 ...
	 */
	@Override
	protected @Nonnull Class<? extends ConfiguartionEntry> getEntityClass() {
		return ConfiguartionEntry.class;
	}
