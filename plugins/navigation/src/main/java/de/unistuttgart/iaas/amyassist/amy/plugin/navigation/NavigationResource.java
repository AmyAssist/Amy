...
public class NavigationResource {
	...
	private boolean checkOriginDestination(String origin, String destination) {
		if (!origin.equals(null) && !origin.equals("") && !destination.equals(null) && !destination.equals("")) {
			return true;
		}
		return false;
	}
